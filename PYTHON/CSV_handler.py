...
## FUNCTIONS ##
def read(CSV_file_path, skiprows=0, print_message=True, delimiter=CSV_DELIMITER):
    #print("In progress: Reading CSV" + CSV_filePath)
    CSV =  pd.read_csv(CSV_file_path, sep=delimiter, skiprows=skiprows)
    if print_message:
